...
This repository contains the source code for WSO2 Integrator: ICP documentation.

This repository is open and we welcome your contributions!

To access the WSO2 Integrator: ICP documentation site, visit https://icp.docs.wso2.com/.

Follow the below topics to learn more:

- [Contributing to WSO2 Integrator: ICP documentation](#contribute)
...
3. The `docs-icp/en/docs/` directory contains all the `.md` files with content. Find the relevant location and do the modification.
...
4. Navigate to the `docs-icp/en/` directory in the terminal and build the repository with the following command:
...
Fork the GitHub repository: https://github.com/wso2/docs-icp.git
...
Navigate to the location where you want to clone the repository and clone the forked repository.
   ...
   ```shell
   git clone https://github.com/<git-username>/docs-icp.git
   ```
...
2. Open the following URL on a new browser window to view the WSO2 Integrator: ICP documentation site locally:
   ...
   >
   > 1. Open the `mkdocs.yml` file located in the `docs-icp/en/docs/` directory.
   >
